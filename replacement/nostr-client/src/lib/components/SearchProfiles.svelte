<script lang="ts">
	// ABOUTME: Search profiles — find Nostr users by name/displayname/pubkey and follow them.
	// ABOUTME: Results are fetched on demand; no data loaded on mount.
				...
				<div class="flex justify-end w-full gap-2">
					<div class="justify-items-start w-full flex-col">
						...
						<div class="w-full flex">
							...
							/>					
								<button type="button" onclick={searchProfile} class="btn ml-2">
									<div class="flex">
				...
				{#each $profiles as profile (profile.pubkey)}
					<div class="flex space-x-1 p-2 hover:bg-gray-400 rounded">
						...
						<div class="w-3/12 flex justify-end">
							<button
								type="button"
								onclick={() => followProfile(profile.pubkey)}
								class="btn"
							>
							<div class="flex">
