<script lang="ts">
	...
	// ABOUTME: Modal displaying all profile metadata fields for a given user.
	// ABOUTME: Receives a Profile via props; provided by svelte-modals.
	let {
		isOpen,
		close,
		profile
			...
			<form>
				...
				<div class="flex space-x-1 p-2">
					<div class="w-6/12 flex justify-end">
						<Button click={close} class="bg-red-500 hover:bg-red-700">Close</Button>
					</div>
				</div>
			</form>
		</div>
